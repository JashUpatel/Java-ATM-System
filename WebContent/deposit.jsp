...
function redirect(button){
  ...
  if (x=='dep') {
    ...
    if (ans == true) {
      ...
      document.getElementById("dep").value="deposit";
       
      return false
     
    } else {
      document.getElementById("dep").value="nodeposit";
...
<i class="fa fa-university fa-5x" id="img" style="color:#ac9766; text-shadow:3px 3px 3px #fff;"></i>
      ...
      <section id="main">
      <div id="log">
<form class="" action="depositServlet" method="post">
        ...
        <table id="tab">
          ...
          <tr>
            ...
            <td style="float:right; margin-right:60px;">
              <button type="submit" onclick="redirect(this)" id="dep" name="dp" value="">Deposit &nbsp;<i class="fas fa-user-check"></i> </button>
            </td>
          </tr>
        </table>
